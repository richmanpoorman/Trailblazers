...
public class Main extends JPanel implements Runnable, MouseMotionListener, ComponentListener {	
	...
	Player p = new Player(10, 10, 30, 30);
	...
	public Main() {
		...
		plats.add(new Platform(10, 300, 10, 2));
		plats.add(new Platform(50, 400, 20, 2));
		plats.add(new Platform(300, 500, 10, 2));
		plats.add(new Platform(110, 600, 20, 2));
		plats.add(new Platform(500, 100, 2, 50));
		t = new Thread(this);
		t.start();
	}
